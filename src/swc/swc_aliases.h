...
#define swc_buttons_bias_direction_plus_choice SWC_BUTTONS_BIAS_DIRECTION_PLUS_CHOICE
#define swc_buttons_bias_direction_minus_choice SWC_BUTTONS_BIAS_DIRECTION_MINUS_CHOICE
...
#define swc_buttons_bias_direction_name SWC_BUTTONS_BIAS_DIRECTION_NAME
