...
#define swc_buttons_encoder_direction_negative_choice SWC_BUTTONS_ENCODER_DIRECTION_NEGATIVE_CHOICE
#define swc_buttons_encoder_direction_positive_choice SWC_BUTTONS_ENCODER_DIRECTION_POSITIVE_CHOICE
#define swc_buttons_encoder_direction_button_choice SWC_BUTTONS_ENCODER_DIRECTION_BUTTON_CHOICE
...
#define swc_buttons_encoder_direction_name SWC_BUTTONS_ENCODER_DIRECTION_NAME
